      ...
      <Container maxWidth="lg" sx={{ pt: 3, pb: 5 }}>
        ...
        >
            ...
            <Typography variant="body2" color={red[500]} fontWeight="bold" mt={1}>
                {currentBanners.length + filesToUpload.length >= MAX_BANNERS ? `Maximum limit of ${MAX_BANNERS} banners reached or exceeded.` : `Remaining slots: ${MAX_BANNERS - currentBanners.length - filesToUpload.length}`}
            </Typography>
        </Paper>
