...
const GeneralMessagesMUI = () => {
  ...
  const handleSendNotification = () => {
    console.log({
      ...
      classes: recipientType === 'Specific Classes' ? selectedClasses : 'N/A'
    })
  ...
  const SelectRecipientsCard = () => (
    <Card elevation={1} sx={{ p: 4, mb: 4, borderRadius: 2 }}>
      ...
      <FormControl component="fieldset" fullWidth>
        ...
        >
          ...
          <FormControlLabel
            ...
            label={
              <Box>
                <Typography variant="subtitle1" fontWeight="medium">Send to All Users</Typography>
                <Typography variant="body2" color="text.secondary">Send notification to all users in the system</Typography>
              </Box>
            }
            sx={{ mb: 2 }}
          />
          ...
          <FormControlLabel
            ...
            label={
              <Box>
                <Typography variant="subtitle1" fontWeight="medium">Send to Staff</Typography>
                <Typography variant="body2" color="text.secondary">Send notification to all staff members</Typography>
              </Box>
            }
            sx={{ mb: 2 }}
          />
          ...
          <FormControlLabel
            ...
            label={
              <Box>
                <Typography variant="subtitle1" fontWeight="medium">Send to Specific Classes</Typography>
                <Typography variant="body2" color="text.secondary">Select individual classes to receive the notification</Typography>
              </Box>
            }
            sx={{ mb: 2 }}
          />
      ...
      {recipientType === 'Specific Classes' && (
      ...
      <Container maxWidth="md">
        ...
        <Box display="flex" justifyContent="flex-end">
          <Button
            ...
            disabled={!notificationTitle || !notificationBody || (recipientType === 'Specific Classes' && selectedClasses.length === 0)}
          >
            Send Notification
          </Button>
        </Box>
